  ...
  return (
    <div className="img-fluid">
      <div  className="pt-3">
        ...
        <h3 className="animated fadeInUp delay-4s mt-2"><strong> A Self-Motivated Front-End Developer and I present here my skills and projects accomplished.</strong></h3>
      </div>
    </div>
  );
}
